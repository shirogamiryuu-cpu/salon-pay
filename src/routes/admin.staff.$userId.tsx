        ...
        <div className="grid grid-cols-3 gap-3 min-w-75">
          <Card>
            <CardContent className="p-3">
              ...
              <div className="text-lg font-bold">{totals.sessions}</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-3">
              <div className="text-[11px] text-muted-foreground">Revenue</div>
              <div className="text-lg font-bold">MMK {totals.revenue.toFixed(2)}</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-3">
              ...
              <div className="text-lg font-bold text-primary">
                MMK {totals.commission.toFixed(2)}
              </div>
            </CardContent>
          </Card>
        </div>
                ...
                <div key={m.ym} className="p-4 flex items-center gap-4">
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-muted-foreground">
                      {m.sessions} sessions · MMK {m.revenue.toFixed(2)} revenue
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-mono font-semibold">MMK {m.commission.toFixed(2)}</div>
                    {m.unpaid > 0 && (
                      <div className="text-xs text-amber-600">MMK {m.unpaid.toFixed(2)} unpaid</div>
                    )}
                  </div>
